...
var API_URI = ' https://agile-lowlands-22666.herokuapp.com/';
...
var getSearchBooks = /*#__PURE__*/function () {
  ...
  return function getSearchBooks(_x2) {
...
var getStars = function getStars(rating) {
  ...
  for (var i = 0; i < 5; i++) {
    if (i === 0) {
      stars.push("<img class=\"cart__rating-star\" src=\"img/star.svg\" alt=\"\u0440\u044D\u0439\u0442\u0438\u043D\u0433 ".concat(rating, " \u0438\u0437 5\">"));
    } else if (i < rating) {
...
var renderList = function renderList() {
  ...
  libraryCount.textContent = declOfNum(books.length, ['книга', 'книги', 'книг']); // let str = `${books.length}`;
...
var changeLabel = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(_ref2) {
    var target, labels, labelsKeys, labelNow, index, indexNext, labelNext;
    return regenerator.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
          ...
          case 3:
            ...
            index = labelsKeys.indexOf(labelNow);
            indexNext = (index + 1) % labelsKeys.length;
            labelNext = labelsKeys[indexNext];
...
var getStarsBook = function getStarsBook(rating) {
  var stars = [];
...
var renderBook = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(id) {
    var _yield$Promise$all, _yield$Promise$all2, books, labels, author, description, image, label, rating, title, btnLabel;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            books = _yield$Promise$all2[0];
            labels = _yield$Promise$all2[1];
            author = books.author, description = books.description, image = books.image, label = books.label, rating = books.rating, title = books.title;
            bookContainer.innerHTML = "\n        <div class=\"book__wrapper\">\n            <img class=\"book__image\" src=\"".concat(API_URI).concat(image, "\" alt=\"\u043E\u0431\u043B\u043E\u0436\u043A\u0430 \u043A\u043D\u0438\u0433\u0438 ").concat(title, "\">\n            \n            <button class=\"book__label book__label_img\" data-label=\"").concat(label, "\" data-id=\"").concat(id, "\">").concat(labels[label], "</button>\n        </div>\n\n        <div class=\"book__content\">\n            <h2 class=\"book__title\">").concat(title, "</h2>\n\n            <p class=\"book__author\">").concat(author, "</p>\n\n            <div class=\"book__rating\">\n                ").concat(getStarsBook(rating).join(''), "\n            </div>\n\n            <h3 class=\"book__subtitle\">\u041E\u043F\u0438\u0441\u0430\u043D\u0438\u0435</h3>\n\n            <p class=\"book__description\">").concat(description, "</p>\n        </div>\n    ");
...
var addBtns = document.querySelectorAll('.header__btn-add, .library__btn-add');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            _context.next = 3;
            return getSearchBooks(searchForm.searchInput.value);
...
var controlField = function controlField(btn, list, offList) {
  ...
  list.addEventListener('click', function (_ref) {
    ...
    if (target.classList.contains('fields__button')) {
      ...
      if (target.dataset.sort) data.sortBooks(target.dataset.sort);
      renderList();

      if (target.dataset.filter) {
        var filteredData = data.filterBooks(target.dataset.filter);
